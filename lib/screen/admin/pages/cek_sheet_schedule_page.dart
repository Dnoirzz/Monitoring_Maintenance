...
import 'mdl_tambah_checksheet.dart';
            ...
            ElevatedButton.icon(
              onPressed: () {
                ModalTambahChecksheet.show(
                  context,
                  (namaInfrastruktur, bagianList) {
                    setState(() {
                      for (var bagian in bagianList) {
                        _rawData.add({
                          "no": _rawData.length + 1,
                          "nama_infrastruktur": namaInfrastruktur,
                          "bagian": bagian["bagian"],
                          "periode": bagian["periode"],
                          "jenis_pekerjaan": bagian["jenis_pekerjaan"],
                          "standar_perawatan": bagian["standar_perawatan"],
                          "alat_bahan": bagian["alat_bahan"],
                          "tanggal_status": Map<int, String>.from({}),
                        });
                      }
                    });
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                          "Schedule $namaInfrastruktur ditambahkan dengan ${bagianList.length} bagian",
                        ),
          ...
          _iconButton(
            ...
            onPressed: () {
              ModalEditChecksheet.show(
                ...
                (updatedItem) {
                  setState(() {
                    // Data sudah diupdate di dalam modal
                  });
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                        "Bagian ${updatedItem["bagian"]} berhasil diupdate",
                      ),
