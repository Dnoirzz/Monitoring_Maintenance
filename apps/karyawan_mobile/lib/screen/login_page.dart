...
import 'teknisi/dashboard_page.dart';
...
class _LoginPageState extends ConsumerState<LoginPage> {
  ...
  Future<void> _handleLogin() async {
    ...
    try {
      ...
      // Login berhasil - navigasi ke dashboard teknisi
      if (mounted) {
        final authState = ref.read(authProvider);
        // Karyawan mobile hanya untuk role teknisi
        if (RouteHelper.isTeknisiRole(authState.userRole)) {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (_) => const TeknisiDashboardPage()),
          );
        } else {
          // Jika bukan teknisi, tampilkan error
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Akses ditolak. Aplikasi ini hanya untuk teknisi.'),
